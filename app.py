...
Ensure accuracy in content extraction and interpretation. Give the content of each question in a new line and in a proper html format where heading is in h2 tag, Q and A are in seperate paragraph tags.  Mention where you get the answer from at last of the respective answer."""
            },
            {
                'role': 'user',
